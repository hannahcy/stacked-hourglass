...
infer=Inference(model='trained/hg_eh_64_8_501')

img=cv2.imread("dataMarsden25-25-SPLITSELECTION/20003.jpg")
...
for i in range(np.shape(hms)[3]):
    ...
    cv2.imwrite('heatmaps-good/Marsden25-25/Individual/eh_64_8_450_20003_'+str(joint_list[i])+'.jpg', temp)
...
cv2.imwrite("heatmaps-good/Marsden25-25/eh_64_8_450_20003.jpg",new_img)