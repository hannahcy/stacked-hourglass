...
img_dir 			= 'dataMarsden4-3/' # Was '~/images/' # Directory of image dataset (.png, .jpg)
data_dir 			= 'dataMarsden4-3csv/' # Was '~/data/ # Directory of .csv files
...
outDim 		        = 3			# Number of output channels (how many joints) (was 16)
